                        ...
                        <div class="row">
                           ...
                           if (mysqli_num_rows($result) > 0) {
                                ...
                                <b>Username:</b> '.$row['username'].'<br>
                                 <b>Phone no.:</b> '.$row['mobile'].'<br>
                                 <b>Match:</b> '.$_POST['movie'].'<br>
                                 <b>Seats:</b> '.implode(",", $_POST["seat"]).' <br>
                                 <b>Payment Date:</b> '.date("D-m-y ",strtotime('today')).'
                                </div>
                            <div class="col-lg-6">
                                
                                 <b>Email:</b> '.$row['email'].'<br>
                                 <b>Total Seats:</b> '.$_POST['totalseat'].' <br>
                                 <b>Time:</b> '.$_POST['show'].'<br>
                                 <b>Booking Date:</b> '.date("D-m-y ",strtotime('tomorrow')).'
                        ...
                        <div id="credit-card" class="tab-pane fade show active pt-3">
                                ...
                                <div class="seatCharts-container">
                                             ...
                                             <div class="front">
                                                ...
                                                <font text-align="right">UGX.<?php echo $price;?>/=</font>
                                            </div>
                                </div>
                            </div>
                                <div id="msg"></div>
