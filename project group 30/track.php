            ...
            <div class="container-fluid">
                <div class="row clearfix">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="header">
                                <h2>Track using Phone Number: </h2>
                            </div>

                            <div class="body">
                                <form id="basic-form" method="post">
                                    <div class="form-group">
                                        <input id="searchdata" type="text" name="searchdata" required="true" class="form-control" placeholder="Enter your Phone Number">
                                    </div>
                                    <br>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <br>
                                        <?php
                                        $sql = "SELECT * from  tblbook where PhoneNumber like '%$sdata%'";
                                            ...
                                            foreach ($results as $row) {               ?>
                                                <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="color: orange;"><?php echo $bookingno = ($row->BookingNumber); ?></td>
                                                    </tr>
                                                    <tr>
                                                        <th>Destination</th>
                                                        <td style="color: orange;"><?php echo $row->Destination; ?></td>
                                                        <th>Pickup Location</th>
                                                        <td style="color: orange;"><?php echo $row->PickupLoc; ?></td>

                                                    </tr>
                                                    <tr>
                                                        <th>Pickup Time</th>
                                                        <td style="color: orange;"><?php echo $row->PickupTime; ?></td>
                                                        <th>Service Type</th>
                                                        <td style="color: orange;"><?php echo $row->ServiceType; ?></td>
                                                    </tr>
                                                    <tr>
                                                        <th>Assign To</th>
                                                        <?php if ($row->AssignTo == "") { ?>
                                                        ...
                                                        <td style="color: orange;"><?php echo $row->DateofRequest; ?></td>
